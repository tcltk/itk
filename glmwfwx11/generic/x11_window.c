    ...
    GlmwfwWindow *winPtr)
{
    ...
    if (HintAtom != None ) {
        ...
        XChangeProperty(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
	        HintAtom, HintAtom, 32, PropModeReplace,
    ...
    if (HintAtom != None) {
        ...
        XChangeProperty(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
	        HintAtom, HintAtom, 32, PropModeReplace,
		(unsigned char *)&GNOMEHints, sizeof(GNOMEHints)/4);
        RemovedDecorations = 1;
    }
    ...
    if (HintAtom != None) {
        ...
        NET_WMHints[0] = XInternAtom(_glmwfwLibrary.Dpy,
	        "_KDE_NET_WM_WINDOW_TYPE_OVERRIDE", True );
        /* define a fallback... */
        NET_WMHints[1] = XInternAtom(_glmwfwLibrary.Dpy,
    ...
    if (RemovedDecorations) {
        ...
        XSetTransientForHint(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
        ...
        XChangeWindowAttributes( _glmwfwLibrary.Dpy,
	        winPtr->platformWindow->Win, CWOverrideRedirect, &attributes);
    ...
    GlmwfwWindow *winPtr)
{
    ...
    HintAtom = XInternAtom(_glmwfwLibrary.Dpy, "_MOTIF_WM_HINTS", True);
    if (HintAtom != None) {
        XDeleteProperty(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
	        HintAtom);
    ...
    HintAtom = XInternAtom(_glmwfwLibrary.Dpy, "_NET_WM_WINDOW_TYPE", True);
    if (HintAtom != None) {
        Atom NET_WMHints = XInternAtom(_glmwfwLibrary.Dpy,
	        "_NET_WM_WINDOW_TYPE_NORMAL", True);
        if (NET_WMHints != None) {
            XChangeProperty(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
                    HintAtom, XA_ATOM, 32, PropModeReplace,
    ...
    int stereo)
{
    ...
    int samplebuffers;
    int vi_samples;
    int vi_samplebuffers;

    // Get list of visuals for this screen & display
    VI_tmp.screen = Screen;
    VI_list = XGetVisualInfo(Dpy, VisualScreenMask, &VI_tmp, &nitems_return);
    if (VI_list == NULL) {
        return NULL;
    }
    ...
    for(i = 0; i < nitems_return; i++) {
	    ...
	    glXGetConfig(Dpy, &VI_list[i], GLX_SAMPLE_BUFFERS,
	            &vi_samplebuffers);
	    ...
	    if (samplebuffers > 0 && vi_samplebuffers == 0) {
	        missing++;
	    }
    ...
    int keycode)
{
    ...
    // Numeric keypad
    case XK_KP_0:
        return GLMWFW_KEY_KP_0;
    case XK_KP_1:
        return GLMWFW_KEY_KP_1;
    case XK_KP_2:
        return GLMWFW_KEY_KP_2;
    case XK_KP_3:
        return GLMWFW_KEY_KP_3;
    case XK_KP_4:
        return GLMWFW_KEY_KP_4;
    case XK_KP_5:
        return GLMWFW_KEY_KP_5;
    case XK_KP_6:
        return GLMWFW_KEY_KP_6;
    case XK_KP_7:
        return GLMWFW_KEY_KP_7;
    case XK_KP_8:
        return GLMWFW_KEY_KP_8;
    case XK_KP_9:
        return GLMWFW_KEY_KP_9;
    case XK_KP_Separator:
    case XK_KP_Decimal:
        return GLMWFW_KEY_KP_DECIMAL;
    case XK_KP_Equal:
        return GLMWFW_KEY_KP_EQUAL;
    case XK_KP_Enter:
    ...
    case XK_KP_Delete:
    case XK_Delete:
        return GLMWFW_KEY_DEL;
    case XK_BackSpace:
        return GLMWFW_KEY_BACKSPACE;
    case XK_Return:
        return GLMWFW_KEY_ENTER;
    case XK_KP_Home:
    case XK_Home:
        return GLMWFW_KEY_HOME;
    case XK_KP_End:
    case XK_End:
        return GLMWFW_KEY_END;
    case XK_KP_Page_Up:
    case XK_Page_Up:
        return GLMWFW_KEY_PAGEUP;
    case XK_KP_Page_Down:
    case XK_Page_Down:
        return GLMWFW_KEY_PAGEDOWN;
    case XK_KP_Insert:
    case XK_Insert:
        return GLMWFW_KEY_INSERT;
    case XK_KP_Left:
    case XK_Left:
        return GLMWFW_KEY_LEFT;
    case XK_KP_Right:
    case XK_Right:
        return GLMWFW_KEY_RIGHT;
    case XK_KP_Down:
    case XK_Down:
        return GLMWFW_KEY_DOWN;
    case XK_KP_Up:
    case XK_Up:
        return GLMWFW_KEY_UP;
    case XK_F1:
        return GLMWFW_KEY_F1;
    case XK_F2:
        return GLMWFW_KEY_F2;
    case XK_F3:
        return GLMWFW_KEY_F3;
    case XK_F4:
        return GLMWFW_KEY_F4;
    case XK_F5:
        return GLMWFW_KEY_F5;
    case XK_F6:
        return GLMWFW_KEY_F6;
    case XK_F7:
        return GLMWFW_KEY_F7;
    case XK_F8:
        return GLMWFW_KEY_F8;
    case XK_F9:
        return GLMWFW_KEY_F9;
    case XK_F10:
        return GLMWFW_KEY_F10;
    case XK_F11:
        return GLMWFW_KEY_F11;
    case XK_F12:
        return GLMWFW_KEY_F12;
    case XK_F13:
        return GLMWFW_KEY_F13;
    case XK_F14:
        return GLMWFW_KEY_F14;
    case XK_F15:
        return GLMWFW_KEY_F15;
    case XK_F16:
        return GLMWFW_KEY_F16;
    case XK_F17:
	return GLMWFW_KEY_F17;
    case XK_F18:
        return GLMWFW_KEY_F18;
    case XK_F19:
        return GLMWFW_KEY_F19;
    case XK_F20:
        return GLMWFW_KEY_F20;
    case XK_F21:
        return GLMWFW_KEY_F21;
    case XK_F22:
        return GLMWFW_KEY_F22;
    case XK_F23:
        return GLMWFW_KEY_F23;
    case XK_F24:
        return GLMWFW_KEY_F24;
    case XK_F25:
        return GLMWFW_KEY_F25;
    // Numeric keypad (should have been detected in secondary keysym!)
    case XK_KP_Divide:
        return GLMWFW_KEY_KP_DIVIDE;
    case XK_KP_Multiply:
        return GLMWFW_KEY_KP_MULTIPLY;
    case XK_KP_Subtract:
        return GLMWFW_KEY_KP_SUBTRACT;
    case XK_KP_Add:
        return GLMWFW_KEY_KP_ADD;
    case XK_KP_Equal:
        return GLMWFW_KEY_KP_EQUAL;
    case XK_KP_Enter:
        return GLMWFW_KEY_KP_ENTER;
    ...
    GlmwfwHints* hints)
{
    ...
    winPtr->platformWindow->VI = _glmwfwChooseVisual(_glmwfwLibrary.Dpy,
            winPtr->platformWindow->Scrn, redbits, greenbits, bluebits,
...
//	PointerMotionHintMask |
	...
	OwnerGrabButtonMask;
    // Create a window
    winPtr->platformWindow->Win = XCreateWindow(_glmwfwLibrary.Dpy,
    ...
    winPtr->platformWindow->WMPing = XInternAtom(_glmwfwLibrary.Dpy,
            "_NET_WM_PING", False);
...
fprintf(stderr, "problems in XCreateIC\n");
	...
	winPtr->platformWindow->Hints->flags |= (PMinSize | PMaxSize);
        winPtr->platformWindow->Hints->min_width =
	        winPtr->platformWindow->Hints->max_width = winPtr->Width;
        winPtr->platformWindow->Hints->min_height =
	        winPtr->platformWindow->Hints->max_height = winPtr->Height;
    }
    if (mode == GLMWFW_FULLSCREEN) {
    ...
    XSetWMNormalHints(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
            winPtr->platformWindow->Hints);
    // Map window
    XMapWindow(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win);
	...
	if (_glmwfwLibrary.XRandR.Available) {
	    XRRSelectInput(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
        ...
        XResizeWindow(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
	        winPtr->Width, winPtr->Height);
        // Grab keyboard
        if (XGrabKeyboard(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
	        True, GrabModeAsync, GrabModeAsync, CurrentTime) ==
		GrabSuccess) {
            winPtr->platformWindow->KeyboardGrabbed = GL_TRUE;
        }
        // Grab mouse cursor
        if (XGrabPointer(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
        ...
        XWarpPointer(_glmwfwLibrary.Dpy, None, winPtr->platformWindow->Win,
	        0,0,0,0, 0,0);
        XWarpPointer(_glmwfwLibrary.Dpy, None, winPtr->platformWindow->Win,
	        0,0,0,0, winPtr->Width/2, winPtr->Height/2);
    }
    // Set window & icon name
    _glmwfwPlatformSetWindowTitle(winPtr, "GLMWFW Window");
    // Connect the context to the window
    glXMakeCurrent(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
            winPtr->platformWindow->CX );
...
fprintf(stderr, "_glmwfwPlatformCloseWindow\n");
	...
	if (_glmwfwLibrary.XRandR.Available) {
	    ...
	    XRRSetScreenConfig(_glmwfwLibrary.Dpy,
	           sc, root, winPtr->platformWindow->FS.OldSizeID,
		   winPtr->platformWindow->FS.OldRotation, CurrentTime);
    ...
    if (winPtr->platformWindow->Saver.Changed) {
        ...
        XSetScreenSaver(_glmwfwLibrary.Dpy,
	        winPtr->platformWindow->Saver.Timeout,
                winPtr->platformWindow->Saver.Interval,
		winPtr->platformWindow->Saver.Blanking,
                winPtr->platformWindow->Saver.Exposure);
...
fprintf(stderr, "_glmwfwPlatformSetWindowSize!%d!\n", winPtr->Fullscreen);
    ...
    if (winPtr->Fullscreen) {
        ...
        mode = _glmwfwGetClosestVideoMode(winPtr->platformWindow->Scrn,
	        &width, &height, &rate);
    }

    if (winPtr->WindowNoResize) {
        winPtr->platformWindow->Hints->min_width =
	        winPtr->platformWindow->Hints->max_width = width;
        winPtr->platformWindow->Hints->min_height =
	        winPtr->platformWindow->Hints->max_height = height;
    }
    XSetWMNormalHints(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
            winPtr->platformWindow->Hints);
    ...
    if (winPtr->Fullscreen) {
        ...
        _glmwfwSetVideoModeMODE(winPtr, winPtr->platformWindow->Scrn,
	        mode, winPtr->Hints.RefreshRate);
    ...
    if (!sizechanged) {
fprintf(stderr, "sizechanged!%d\n", sizechanged);
        XResizeWindow(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win, width,
	        height);
        XFlush(_glmwfwLibrary.Dpy);
    }
    return TCL_OK;
}
    ...
    GlmwfwWindow *winPtr)
{
    ...
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_RED_SIZE, &winPtr->RedBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_GREEN_SIZE, &winPtr->GreenBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_BLUE_SIZE, &winPtr->BlueBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_ALPHA_SIZE, &winPtr->AlphaBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_DEPTH_SIZE, &winPtr->DepthBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_STENCIL_SIZE, &winPtr->StencilBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_ACCUM_RED_SIZE, &winPtr->Hints.AccumRedBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_ACCUM_GREEN_SIZE, &winPtr->Hints.AccumGreenBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_ACCUM_BLUE_SIZE, &winPtr->Hints.AccumBlueBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_ACCUM_ALPHA_SIZE, &winPtr->Hints.AccumAlphaBits);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_AUX_BUFFERS, &winPtr->Hints.AuxBuffers);

    // Get stereo rendering setting
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_STEREO, &winPtr->Hints.Stereo);
    winPtr->Hints.Stereo = winPtr->Hints.Stereo ? 1 : 0;

    // Get multisample buffer samples
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
            GLX_SAMPLES, &winPtr->Hints.Samples);
    glXGetConfig(_glmwfwLibrary.Dpy, winPtr->platformWindow->VI,
    ...
    if (_glmwfwLibrary.XF86VidMode.Available) {
        ...
        winPtr->platformWindow->RefreshRate = 
	        (int)(pixels_per_second/pixels_per_frame+0.5);
    }
#endif
    return TCL_OK;
}
    ...
    GlmwfwWindow *winPtr)
{
    ...
    if (winPtr->input.platformInput->MouseMoved && winPtr->MouseLock) {
        ...
        if (winPtr->input.platformInput->CursorPosX < minx ||
	        winPtr->input.platformInput->CursorPosX > maxx ||
                winPtr->input.platformInput->CursorPosY < miny ||
		winPtr->input.platformInput->CursorPosY > maxy) {
    ...
    if (winPtr->platformWindow->MapNotifyCount < 0 && !winPtr->Iconified) {
        ...
        if (winPtr->platformWindow->MapNotifyCount > 0 && winPtr->Iconified) {
            ...
            if (winPtr->Fullscreen) {
                ...
                _glmwfwSetVideoMode(winPtr, winPtr->platformWindow->Scrn,
		        &winPtr->Width, &winPtr->Height,
			&winPtr->Hints.RefreshRate);
                // Disable window manager decorations
                _glmwfwEnableDecorations(winPtr);
                // Make sure window is in upper left corner
                XMoveWindow(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
		        0, 0);
                // Get input focus
                XSetInputFocus(_glmwfwLibrary.Dpy, winPtr->platformWindow->Win,
                        RevertToParent, CurrentTime);
            ...
            if (winPtr->MouseLock && !winPtr->platformWindow->PointerHidden) {
                if (!winPtr->platformWindow->PointerHidden) {
                    XDefineCursor(_glmwfwLibrary.Dpy,
		            winPtr->platformWindow->Win,
                            _glmwfwCreateNULLCursor(_glmwfwLibrary.Dpy,
                            winPtr->platformWindow->Win));
                    winPtr->platformWindow->PointerHidden = GL_TRUE;
            ...
            if ((winPtr->MouseLock || winPtr->Fullscreen) &&
                ...
                if (XGrabPointer(_glmwfwLibrary.Dpy,
		        winPtr->platformWindow->Win, True,
...
int
_glmwfwPlatformHideMouseCursor(
    GlmwfwWindow *winPtr)
{
    // Hide cursor
    if (!winPtr->platformWindow->PointerHidden) {
...
int
_glmwfwPlatformShowMouseCursor(
    GlmwfwWindow *winPtr)
{
...
int
_glmwfwPlatformSetMouseCursorPos(
    GlmwfwWindow *winPtr,
    int x,
    int y)
{
