...
// Fullscreen support
int _glmwfwGetClosestVideoModeBPP( int *w, int *h, int *bpp, int *refresh );
int _glmwfwGetClosestVideoMode( int *w, int *h, int *r, int *g, int *b, int *refresh );
void _glmwfwSetVideoModeMODE( int mode );
void _glmwfwSetVideoMode( int *w, int *h, int r, int g, int b, int refresh );
