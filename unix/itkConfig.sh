...
# build directory.
ITK_BUILD_LIB_SPEC='-L/home/redman/ws/incrTcl/itk/unix -litk3.0'

# String to pass to linker to pick up the Itk library from its
# installed directory.
ITK_LIB_SPEC='-L/usr/local/lib -litk3.0'

# The name of the Itk stub library (a .a file):
ITK_STUB_LIB_FILE=libitkstub3.0.a

# String to pass to linker to pick up the Itk stub library from its
# build directory.
ITK_BUILD_STUB_LIB_SPEC='-L/home/redman/ws/incrTcl/itk/unix -litkstub3.0'

# String to pass to linker to pick up the Itk stub library from its
# installed directory.
ITK_STUB_LIB_SPEC='-L/usr/local/lib -litkstub3.0'
...
ITK_SRC_DIR='/home/redman/ws/incrTcl/itk'
