...
#
# RCS: @(#) $Id: spinbox_1.tcl,v 1.1.2.1 2007/11/29 20:16:59 wiede Exp $
#--------------------------------------------------------------------------
...
::ntk::glmwfw::Glmwfw setWindowTitle $::ntk::_win "NtkWidget Spinbox Demo 1"

set rotate 0
if {[llength $argv] > 0} {
    set rotate [lindex $argv 0]
}
set wPath [ntk spinbox .w -width 100 -height 30 -xoffset 50 -yoffset 50 \
-bd 2 -bg [list 175 175 175 255] -items [list item1 item2 item3 item4 item5 item6 item7 item8 item9] -itemindex 0 -textcolor [list 0 0 255 255]]
