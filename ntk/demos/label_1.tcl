...
#
# RCS: @(#) $Id: label_1.tcl,v 1.1.2.1 2007/11/25 15:35:07 wiede Exp $
#--------------------------------------------------------------------------
...
::ntk::glmwfw::Glmwfw setWindowTitle $::ntk::_win "NtkWidget Label Demo 1"
...
set wPath [ntk label .w -width 100 -height 100 -xoffset 50 -yoffset 50 \
