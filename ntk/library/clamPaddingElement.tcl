#---------------------------------------------------------------------------
# ntkWidget clamPaddingElement.tcl --
#
# This file contains a ntkWidget clamPaddingElement commands implementation
#
...
#
# RCS: @(#) $Id: clamPaddingElement.tcl,v 1.1.2.1 2007/12/31 14:50:37 wiede Exp $
#--------------------------------------------------------------------------

::itcl::extendedclass ::ntk::classes::clamPaddingElement {
