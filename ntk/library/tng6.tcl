...
#puts stderr "DispatchMouseButton!$num!$state!"
    incr num
    if {$state == 0} {
        ntk mousePress . $num $mouseX $mouseY
    } else {
        ntk mouseRelease . $num $mouseX $mouseY
    }
}
...
proc DispatchWindowRefresh {} {
    ...
    ntk render .
    puts stderr "after DispatchWindowRefresh!"
}
...
set hght 600
::ntk::glfw::Glfw init
set win [::ntk::glfw::Glfw openWindow $wdth $hght]
::ntk::glfw::Glfw setWindowTitle "ntkWidget Demo with GLFW"
