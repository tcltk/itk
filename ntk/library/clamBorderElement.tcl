#---------------------------------------------------------------------------
# ntkWidget clamBorderElement.tcl --
#
# This file contains a ntkWidget clamBorderElement commands implementation
#
...
#
# RCS: @(#) $Id: clamBorderElement.tcl,v 1.1.2.1 2007/12/31 14:50:36 wiede Exp $
#--------------------------------------------------------------------------

::itcl::extendedclass ::ntk::classes::clamBorderElement {
