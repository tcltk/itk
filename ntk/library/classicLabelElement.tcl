#---------------------------------------------------------------------------
# ntkWidget classicLabelElement.tcl --
#
# This file contains a ntkWidget classicLabelElement commands implementation
#
...
#
# RCS: @(#) $Id: classicLabelElement.tcl,v 1.1.2.1 2007/12/31 14:49:36 wiede Exp $
#--------------------------------------------------------------------------

::itcl::extendedclass ::ntk::classes::classicLabelElement {
